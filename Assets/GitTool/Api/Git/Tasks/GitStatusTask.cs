...
namespace Unity.VersionControl.Git.Tasks
{
    public class GitStatusTask : GitProcessTask<GitStatus>
    {
        ...
        public override string ProcessArguments => "-c i18n.logoutputencoding=utf8 -c core.quotepath=false --no-optional-locks status -b -u --porcelain --porcelain --no-ignore-submodules";
