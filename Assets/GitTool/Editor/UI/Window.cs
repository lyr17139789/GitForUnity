...
namespace Unity.VersionControl.Git.UI
{
    ...
    class Window : BaseWindow
    {
        ...
        [SerializeField] private GUIContent mergeButtonContent = new GUIContent("Merge");
            ...
            GUILayout.BeginHorizontal(EditorStyles.toolbar);
            {
                if (hasRemote)
                {
                    EditorGUI.BeginDisabledGroup(currentRemoteName == null);
                    {
                        ...
                        // Merge button
                        var mergeClicked = GUILayout.Button(mergeButtonContent, Styles.ToolbarButtonStyle);
                        if (GUILayout.Button("Merge", Styles.ToolbarButtonStyle))
                        {
                            // TODO: Merge
                        }
