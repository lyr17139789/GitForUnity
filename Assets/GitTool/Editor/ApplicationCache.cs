            ...
            get
            {
                if (environment == null)
                {
                    ...
                    if (projectPath == null)
                    {
                        ...
                        Debug.Log($"unityApplication: {unityApplication}");
                        Debug.Log($"unityApplicationContents: {unityApplicationContents}");
                        Debug.Log($"extensionInstallPath: {extensionInstallPath}");
                    }
